    ...
    return this['each'](function() {
      ...
      */
      ...
      touchHandler = function(e) {
        var absDeltaX, absDeltaY, borderLeftWidth, deltaX, deltaY, touch, x, y;
        ...
        switch (e.type) {
          case EventType.MOVE:
            ...
            if (state & STATE.IS_MOVING) {
              ...
              if (state & STATE.IS_EDGE && (((state & STATE.IS_FIRST) && deltaX > 0) || ((state & STATE.IS_LAST) && deltaX < 0))) {
                deltaX = deltaX / 2;
              }
              return $box['css'](CSS_TRANSFORM, getCssTranslateValue(containerBaseX + startLeft + deltaX));
            }
            break;
      ...
      vsnap = function() {
        var counter, deltaY, duration, fps, loopCount, scrollY, timer, top, y;
