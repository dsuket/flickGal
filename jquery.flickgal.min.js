...
a.clientY;if(H)break;if(h&i.j){c-=I;j-=O;if(!E){if(Math.abs(j)>d.scrollMargin){H=!0;break}if(Math.abs(c)<d.scrollMargin)break;E=!0;if(d.vsnap)j=o.r().top,window.scrollY!==j&&window.scrollTo(0,j)}d.lockDirection&&a.preventDefault();if(h&i.i&&(h&i.d&&c>0||h&i.e&&c<0))c/=2;return g.css(r,x(q+u+c))}break;case e.a:f||a.preventDefault();E=H=!1;h|=i.j;b===0&&(h|=i.d);b===m-1&&(h|=i.e);if(h&i.d||h&i.e)h|=i.i;N=(new Date).getTime();I=f?j.pageX:a.clientX;O=f?j.pageY:a.clientY;u=G()-D-q;a=o.q("border-left-width");
